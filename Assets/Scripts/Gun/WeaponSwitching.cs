...
public class WeaponSwitching : MonoBehaviour {
    ...
    private void Select(int newWeaponIndex) {
        ...
        weapons[newWeaponIndex].gameObject.GetComponent<GunScriptV2>().ammunitionText.SetText("Ammo: " + weapons[newWeaponIndex].gameObject.GetComponent<GunScriptV2>().ammunitionInGun);
